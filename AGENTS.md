...
- This repository is intended for public distribution but stays private until product launch. Never commit credentials, real user logs, local experiment files, or private deployment details.
